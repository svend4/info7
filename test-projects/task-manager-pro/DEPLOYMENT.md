...
This guide covers deploying Task Manager Pro to various platforms.
...
4. Configure:
   ...
   - **Root Directory:** test-projects/task-manager-pro
   - **Environment:** Node
...
1. `20260201000000_init_task_manager_schema.sql` - Core schema
2. `20260201000001_create_tasks_table.sql` - Tasks table
3. `20260201000002_create_categories_table.sql` - Categories
4. `20260201000003_create_tags_tables.sql` - Tags
5. `20260201000004_create_rls_policies.sql` - Row Level Security
6. `20260201000005_create_indexes.sql` - Performance indexes
